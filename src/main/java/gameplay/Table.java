...
import gameplay.players.PlayerBase;
...
public class Table {
   ...
   // Players
   public List<PlayerBase> players = new ArrayList<PlayerBase>();
   ...
   public Card dealCard(PlayerBase player) {
   ...
   // Choose card for testing
   public Card dealCard(PlayerBase player, Card card) {
      player.hand.add(card);
      return card;
   }
